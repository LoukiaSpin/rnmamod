...
#'
#' @description The WinBUGS code, as written by Dias et al. (2013) to run a one-stage Bayesian unrelated mean effects model, extended to incorporate the pattern-mixture model for binary or continuous missing participant outcome data.
#'
...
#'
#' @seealso \code{\link{run.UME}}, \code{\link[base]{textconnections}}, \code{\link[R2jags]{jags}}
#'
#' @references
