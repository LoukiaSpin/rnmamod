...
the investigator's global assessment response at 4 weeks 
...
The users can export all tables in Excel 'xlsx' format at the working directory 
...
\emph{Curr Med Res Opin} 2011;\bold{27}(1):251--268. 
...
Network Meta-Analysis in R with the pcnetmeta Package. \emph{J Stat Softw} 2017;
\bold{80}(5): 1--25. 
